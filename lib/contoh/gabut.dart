...
//             return faqs.take(3).toList(); // Ambil 3 data pertama yang sudah diacak
//           }
//         }
//       }
//     }
...
//   // Fungsi untuk membangun breadcrumb berdasarkan kategori, subkategori dan FAQ
//   String buildBreadcrumb(List<dynamic> categories) {
//     String breadcrumb = '';
//     for (var category in categories) {
//       for (var subcategory in category['subcategories']) {
//         if (subcategory['name'] == widget.subsCategory) {
//           breadcrumb += '${category['name']} $frontArrow ${subcategory['name']} $frontArrow ${widget.question}';
//         }
//       }
//     }
//     return breadcrumb;
